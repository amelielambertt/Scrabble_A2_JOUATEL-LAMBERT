    ...
    class Jeu
    {
        ...
        public int TourDUnJoueur(Joueur joueurJouant, int compteurDeTour)
        {
            ...
            while (confirmation == -1) // Tant qu'aucune option n'est confirmée
            {
                ...
                Affichage902IQ(joueurJouant.Main, optionSelectionnée,compteurDeTour, plateauCurseur, plateauFactice, curseurx, curseury, SURLEPLATEAU,"Placez les lettres souhaitées sur le plateau"); // Afficher le menu
        ...
        public void Affichage902IQ(List<Jetons> main, int surbrillance, int compteurDeTour, char[,] plateauCurseur, char[,] plateauFactice, int curseurx, int curseury, bool SURLEPLATEAU, string bienvenue)
        {

            Console.WriteLine('\t' + "Tour : " + compteurDeTour);
            this.MonPlateau.AffichageOMGFactice(this.ListeDesJoueurs, plateauCurseur, plateauFactice, curseurx, curseury, SURLEPLATEAU);
            Console.WriteLine();
            Console.WriteLine();
